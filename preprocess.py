...
if __name__ == '__main__':
    ...
    for i in range(train_size):
        train_file.write(str(q[i]))
        train_file.write("\n")
        train_file.write(str(ans[i]))
        train_file.write("\n")
        train_file.write(str(q_prob[i]))
        train_file.write("\n")
        train_file.write(str(ans_prob[i]))
        train_file.write("\n")
        train_file.write(str(label[i]))
        train_file.write("\n")
    train_file.close()

    for i in range(train_size, train_size + valid_size):
        valid_file.write(str(q[i]))
        valid_file.write("\n")
        valid_file.write(str(ans[i]))
        valid_file.write("\n")
        valid_file.write(str(q_prob[i]))
        valid_file.write("\n")
        valid_file.write(str(ans_prob[i]))
        valid_file.write("\n")
        valid_file.write(str(label[i]))
        valid_file.write("\n")
    valid_file.close()

    for i in range(valid_size, qa_size):
        test_file.write(str(q[i]))
        test_file.write("\n")
        test_file.write(str(ans[i]))
        test_file.write("\n")
        test_file.write(str(q_prob[i]))
        test_file.write("\n")
        test_file.write(str(ans_prob[i]))
        test_file.write("\n")
        test_file.write(str(label[i]))
        test_file.write("\n")
    test_file.close()
